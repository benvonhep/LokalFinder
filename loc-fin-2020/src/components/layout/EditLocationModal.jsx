      ...
      <Form noValidate validated={validated} onSubmit={onSubmit}>
        <Modal.Body>
          ...
          <Form.Group controlId="photo">
            ...
            <Form.Control required type="text" name="photo" defaultValue={location.photo || ''} onChange={onChange} placeholder="Enter photo url" />
            <Form.Control.Feedback type="invalid">
          ...
          <Form.Group controlId="description">
            ...
            <Form.Control required type="text" name="description" defaultValue={location.description || ''} onChange={onChange} placeholder="Enter description" />
            <Form.Control.Feedback type="invalid">
          ...
          <Form.Group controlId="openingTime">
            ...
            <Form.Control required type="text" name="openingTime" defaultValue={location.openingTime || ''} onChange={onChange} placeholder="Enter opening times" />
            <Form.Control.Feedback type="invalid">
          ...
          <Form.Group controlId="phone">
            ...
            <Form.Control required type="text" name="phone" defaultValue={location.phone || ''} onChange={onChange} placeholder="Enter phone number" />
            <Form.Control.Feedback type="invalid">
          ...
          <Form.Group controlId="street">
            ...
            <Form.Control required type="text" name="street" defaultValue={location.street || ''} onChange={onChange} placeholder="Enter street" />
            <Form.Control.Feedback type="invalid">
          ...
          <Form.Group controlId="city">
            ...
            <Form.Control required type="text" name="city" defaultValue={location.city || ''} onChange={onChange} placeholder="Enter city" />
            <Form.Control.Feedback type="invalid">
